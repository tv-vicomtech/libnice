...
static gboolean
notify_pseudo_tcp_socket_clock_agent_locked (gpointer user_data)
{
  NiceComponent *component = user_data;
  NiceStream *stream;
  NiceAgent *agent;
...
static gboolean priv_upnp_timeout_cb_agent_locked (gpointer user_data)
{
...
static TimeoutData *
timeout_data_new (NiceAgent *agent, GSourceFunc function, gpointer user_data)
{
...
timeout_cb (gpointer user_data)
{
  ...
  ret = data->function (data->user_data);
...
void agent_timeout_add_with_context (NiceAgent *agent, GSource **out,
    const gchar *name, guint interval, GSourceFunc function, gpointer user_data)
{
  GSource *source;
  TimeoutData *data;
